    ...
    <div className="page-shell routes-shell" style={styles.appShell}>
      ...
      <main className="page-main routes-main" style={styles.mainContent}>
        ...
        <div className="pageHeader" style={styles.pageHeader}>
          ...
          <p className="subtitle" style={styles.subtitle}>Setiap pos sepanjang rute jeep menyimpan satu mini game. Buka titik untuk membaca instruksi.</p>
        </div>

        <div className="list" style={styles.list}>
          {routes.map((route) => (
            <Link className="card" href={`/customer/routes/${route.id}`} key={route.position} style={{ ...styles.card, textDecoration: 'none', color: 'inherit' }}>
