      ...
      <main className="page-main dashboard-main" style={styles.mainContent}>
        ...
        <div className="heroCard" style={styles.heroCard}>
          ...
          <div className="buttonRow" style={styles.buttonRow}>
            <Link className="primaryButton" href="/customer/routes" style={styles.primaryButton}><HeroIcon type="map" />Lihat Rute &amp; Games</Link>
            <Link className="secondaryButton" href="/customer/scoreboard" style={styles.secondaryButton}><StatIcon type="trophy" />Papan Skor</Link>
          </div>
        ...
        <div className="sectionHeader" style={styles.sectionHeader}>
          ...
          <Link className="linkText" href="/customer/routes" style={styles.linkText}>Semua titik →</Link>
        </div>

        <div className="routeList" style={styles.routeList}>
          {routeData.map((route, index) => (
            <Link className="routeItem" href={`/customer/routes/${route.id}`} key={route.id} style={{ ...styles.routeItem, textDecoration: 'none', color: 'inherit' }}>
        ...
        <div className="leaderCard" style={styles.leaderCard}>
          ...
          <Link className="leaderButton" href="/customer/scoreboard" style={styles.leaderButton}>Lihat Papan Skor →</Link>
        </div>
      </main>
    </div>
  );
